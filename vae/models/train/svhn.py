...
class Encoder(hk.Module):
    ...
    def encoder_model(self, x:Array)->Array:
        ...
        x = tanh(self.bnorm1(self.enc1(x), True))
        x = tanh(self.bnorm2(self.enc2(x), True))
        x = tanh(self.bnorm3(self.enc3(x), True))
        x = tanh(self.bnorm4(self.enc4(x), True))
        
        return tanh(self.bnorm5(self.fc1(x.reshape(x.shape[0], -1)), True))
...
class Decoder(hk.Module):
    ...
    def decoder_model(self, x:Array)->Array:
        ...
        x = tanh(self.bnorm1(self.dec1(x), True))
        x = tanh(self.bnorm2(self.dec2(x), True))
        x = tanh(self.bnorm3(self.dec3(x), True))
        x = tanh(self.bnorm3(self.dec4(x), True))
